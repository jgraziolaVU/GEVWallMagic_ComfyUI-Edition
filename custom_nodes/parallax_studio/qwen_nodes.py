...
class ImageBypassSwitch:
    """Switch between two image inputs based on boolean toggle."""
    ...
    def switch(self, image_if_true, image_if_false, use_enhanced):
        if use_enhanced:
            print("[Parallax Studio] Using Qwen-enhanced image")
            return (image_if_true,)
        else:
            print("[Parallax Studio] Bypassing Qwen, using original")
            return (image_if_false,)
